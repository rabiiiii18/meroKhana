  ...
  return (
    <div>
      <div>
        <Header />
        {recipe ? (
          <div className="h-[110vh] md:h-[100vh] sm:h-[110vh] overflow-hidden">
            <div className="bg-gray-100 h-[260px] w-full relative flex justify-center select-none ">
              <div className=" h-auto  absolute w-[90%] mt-[4%] rounded-2xl">
                <div className="flex flex-col md:flex-row sm:flex-col justify-between gap-5 p-3 sm:gap-5 md:gap-20">
                  <div className="w-full sm:w-full md:w-[40%]  h-[300px] sm:h-[300px] md:h-[600px] overflow-hidden">
                    <img
                  ...
                  <div className="w-full sm:w-full md:w-[60%] rounded-2xl h-auto ">
                    <div className="flex flex-col px-4">
                      <span className="text-[16px] sm:text-[16px] md:text-[18px] font-semibold text-[#E92D28] leading-[40px]">
                        {recipe.category}
                      </span>
                      <span className="text-[25px] sm:text-[25px] md:text-[35px] leading-[42px] font-semibold">
                        {recipe.title}
                      </span>
                    </div>

                    <div className=" flex flex-wrap sm:flex-wrap px-5 mt-8 gap-10 justify-between ">
                    ...
                    <div className="mt-8 flex justify-between items-center pt-4">
                      ...
                      <div className="flex justify-center items-center gap-6 ">
                        <div className="flex justify-center items-center">
                          <img
                            src="/user.jpg"
                            className="w-[60px] sm:w-[60px] md:w-[70px] rounded-full"
                          />
                        </div>
                    ...
                    <div className="mt-4 select-none">
                      <div className=" flex  items-center text-[17px] sm:text-[17px] md:text-[20px] leading-[31px] text-[#a1a1aa] font-semibold gap-4">
                        Ingredients{" "}
                        <span className="text-black text-[20px]">
                          {recipe.serving + count} Person(s)
                        </span>
                      </div>
                    </div>
                    <div>
                      <div className="p-4 h-auto overflow-y-auto select-none">
                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3  gap-12 max-w-auto max-h-[250px] overflow-y-auto">
